                ...
                <tr>
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td class="text-center">
                            <div class="box">
                                <img src="<?php echo e($setting->path_kartu_member); ?>" alt="card" width="325px">
                                <div class="logo">
                                    <p><?php echo e($setting->nama_perusahaan); ?></p>
                                    <img src="<?php echo e($setting->path_logo); ?>" alt="logo">
                                </div>
                                <div class="nama"><?php echo e($item->nama_member); ?></div>
...
</html><?php /**PATH C:\xampp\htdocs\kasir\resources\views/member/cetak.blade.php ENDPATH**/ ?>