                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-4">
                                <form action="{{ route('transaksi.simpan') }}" class="form-penjualan" method="post">
                                    ...
                                    <input type="hidden" name="id_member" id="id_member" value="{{$member_id->id_member}}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="kode_member" value="{{$member_id->kode_member}}">
                                                <span class="input-group-btn">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="number" name="diskon" id="diskon" class="form-control" value="{{ ! empty($member_id->id_member) ? $diskon : 0 }}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" id="diterima" name="diterima" value="{{$penjualan->diterima ?? 0}}" class="form-control" autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group row">
